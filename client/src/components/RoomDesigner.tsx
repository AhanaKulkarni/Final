...
export function RoomDesigner() {
  ...
  return (
    <div className="w-full bg-gradient-to-br from-stone-50 to-amber-50" style={{ minHeight: '200vh' }}>
      {/* Undo/Redo Controls */}
      <UndoRedo />
      ...
      <div className="w-full flex items-center justify-center p-1" style={{ minHeight: '100vh' }}>
        {viewMode === '2d' ? (
          <>
            <Canvas2D />
            <FurnitureLibrary />
