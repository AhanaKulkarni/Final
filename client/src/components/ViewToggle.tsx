      ...
      <div className="fixed top-4 right-4 z-50 bg-gradient-to-br from-white/98 to-amber-50/95 backdrop-blur-md rounded-xl p-3 shadow-xl border border-stone-200">
        <div className="flex gap-2">
          <Button
            ...
            className="text-sm flex items-center gap-2 px-3 py-2 transition-all duration-200"
          >
            <Edit3 size={16} />
            2D Design
          </Button>
          ...
          <Button
            ...
            className="text-sm flex items-center gap-2 px-3 py-2 transition-all duration-200 bg-gradient-to-r from-amber-500 to-orange-500 text-white border-amber-400 hover:from-amber-600 hover:to-orange-600"
          >
            <Camera size={16} />
            AR
          </Button>
